...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: '/help-request-interface', label: "Vull ajudar", icon: Heart, color: 'text-rose-600', activeBg: 'bg-rose-50' },
    { href: '/support-locator', label: "Necessito ajuda", icon: MapPin, color: 'text-blue-600', activeBg: 'bg-blue-50' },
    { href: '/internal-dashboard', label: "Panell", icon: LayoutDashboard, color: 'text-emerald-600', activeBg: 'bg-emerald-50' },
  ];
